package com.gstcalculator.domain.model
...
/** Sort palette index 0..N-1 mapped to UI colors in [GSTCalculatorPalette]. */
data class GSTCalculatorLevel(
    val id: Long = 0,
    val seed: Long,
    val levelNumber: Int,
    val difficulty: Difficulty,
    val initialTubes: List<List<Int>>,
    val tubeCapacity: Int = GSTCalculatorLevel.DEFAULT_CAPACITY,
    val colorCount: Int,
