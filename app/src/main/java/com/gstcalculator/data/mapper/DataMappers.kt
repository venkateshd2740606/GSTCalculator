package com.gstcalculator.data.mapper
...
object DataMappers {
    ...
    fun toEntity(game: GSTCalculatorGame): GameEntity = GameEntity(
        id = game.id,
    ...
    fun fromEntity(entity: GameEntity): GSTCalculatorGame {
